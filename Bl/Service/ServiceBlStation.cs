...
namespace Bl.Service
{
    public class ServiceBlStation : IBlStation
    {
        ...
        {
            List<BLstation> fullStation = new List<BLstation>();

            var stations = await dal.StationService.Get();
            // רשימת תחנות ממסד הנתונים
            foreach (var station in stations)
            {
                ...
                var m =await dal.MeasurementService.GetMeasure(fileName); // רשימת מדידות ממסד הנתונים
        ...
        public void CreateStation(Station s)
            ...
            public async Task< List<Station>> GetAllStations()
            {
                try
                {
                    return await dal.StationService.Get();
                }
                catch (Exception ex)
                {
