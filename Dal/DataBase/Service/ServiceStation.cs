...
namespace Dal.DataBase.Service
{
    public class ServiceStation : IStatoin
    {
        ...
        public async Task< bool > Create1(GetCalculateDatum cal)
        {
            try
            {
        ...
        public async Task< List<GetCalculateDatum>> GetCalculateFullData()
        {
            return  data.GetCalculateData.ToList();

        }
        public List<Station> Search(Func<Station, bool> func)
        {
        ...
        public async Task< bool> Update(Station s, string name)
        {
            try
            {
                // מחפש תחנה לפי שם
